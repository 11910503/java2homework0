...
//            }
    ...
    public MovieAnalyzer(String dataset_path) throws IOException {
        ...
        Files.lines(Paths.get(location))
                .skip(1)
                .map(l -> getline(l))
                .map(Movid::new).forEach(a->{allmovid.add(a);});
    }
    ...
    public Map<String, Integer> getMovieCountByGenre() throws IOException {
        ...
        arrayList1.sort(new Comparator<String>() {
            ...
            public int compare(String o1, String o2) {
                ...
                if(o1n==o2n){return o1.compareTo(o2);}
                return o2n-o1n;
            }
        });
    ...
    public static String[] getline(String line){
        ...
        for(int i=0;i<characters.length;i++){
            if(characters[i]=='\"'){k=i;num++;is=true;continue;}
            if(characters[i]==','){
                if(num%2==0||!is){
        ...
        if (by.equals("runtime")) {
            movidStream.sorted(new Comparator<Movid>() {
                ...
                public int compare(Movid o1, Movid o2) {
                    ...
                    if(o1n==o2n){return o1.Series_Title.compareTo(o2.Series_Title);}
                    return o2n-o1n;
                }
        ...
        if (by.equals("overview")) {
            movidStream.sorted(new Comparator<Movid>() {
                ...
                public int compare(Movid o1, Movid o2) {
                    ...
                    if(o1.Overview.substring(o1n-1).equals("\"")){o1n-=2;}
                    if(o2.Overview.substring(o2n-1).equals("\"")){o2n-=2;}
                    if(o1n==o2n){return o1.Series_Title.compareTo(o2.Series_Title);}
                    return o2n-o1n;
                }
            }).limit(top_k).forEach(a-> {
        ...
        if(by.equals("rating")){
            ...
            arrayList.sort(new Comparator<String>() {
                ...
                public int compare(String o1, String o2) {
                    ...
                    if(o1n.equals(o2n)){return o1.compareTo(o2);}
        ...
        movidStream.filter(new Predicate<Movid>() {
                    ...
                    public boolean test(Movid movid) {
                        for (int i=0;i<movid.getGenre().length;i++){
                            if(movid.getGenre()[i].equals(genre)){return true;}
                        }
                        return false;
                    }
                })
